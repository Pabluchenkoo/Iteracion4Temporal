...
(ID NUMBER NOT NULL,
 ...
 UNIDADDEMEDIDA VARCHAR2(100 BYTE) NOT NULL,
 ESPECIFICACION VARCHAR2(100 BYTE) NOT NULL,
...
(IDCARRITO NUMBER NOT NULL,
 ...
 CONSTRAINT CK_ASIGNADO CHECK (ASIGNADO IN ('Y','N'))
);
